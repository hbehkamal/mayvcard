...
var Boxlayout = (function() {
		...
		// work items
		$workItems = $( '#bl-work-items .workimga' ),				
		$workItems1 = $( '#bl-work-items .worktitle > a' ),		
		...
		// blog items
		$blogItems = $( '#bl-blog-items > .blog-post a' ),
	...
	function initEvents() {
		...
		$workItems1.on( 'click', function( event ) {
		...
		// clicking on a blog item: the current section scales down and the respective blog panel slides up
		$blogItems.on( 'click', function( event ) {

			// scale down main section
			$sectionBlog.addClass( 'bl-scale-down' );

			// show panel for this blog item
			$blogPanelsContainer.addClass( 'bl-panel-items-show' );

			var $panel1 = $blogPanelsContainer.find("[data-panel='" + $( this ).data( 'panel' ) + "']");
			currentBlogPanel = $panel1.index();
			$panel1.addClass( 'bl-show-blog' );
		...
		// navigating the blog items: current blog panel scales down and the next blog panel slides up
		...
		// clicking the blog panels close button: the current blog panel slides down and the section scales up again
